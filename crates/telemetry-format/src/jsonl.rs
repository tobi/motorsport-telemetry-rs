...
use motorsport_telemetry_core::{
    ...
    AppliedPass, Channel, ChannelDisplay, ChannelLabel, ChannelPlot, Chunk, FileMetadata,
    LapMetadata, SampleType, SourceIdentity, SourceLapMetadata, SourceOrigin, TelemetrySource,
    UnitSource, VideoFileRef, TIMESPAN_MS,
};
